...
import erp.controles.cadastro.CFichaCorrentista;
 ...
 * @author Arthur
 */
public class VFichaCorrentista extends javax.swing.JInternalFrame {

    CFichaCorrentista controle;

    public VFichaCorrentista() {
        initComponents();

        controle = new CFichaCorrentista();
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        CFrame.fechaVisao(CFrame.VISOES.FICHA_CORRENTISTA);
