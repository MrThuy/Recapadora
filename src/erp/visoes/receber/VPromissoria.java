...
import erp.controles.receber.CPromissória;
 ...
 * @author Arthur
 */
public class VPromissoria extends javax.swing.JInternalFrame {

    CPromissória controle;

    public VPromissoria() {
        initComponents();

        controle = new CPromissória();
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        CFrame.fechaVisao(CFrame.VISOES.PROMISSORIA);
