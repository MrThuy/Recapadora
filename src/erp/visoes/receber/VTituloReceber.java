...
import erp.controles.receber.CTituloReceber;
 ...
 * @author Arthur
 */
public class VTituloReceber extends javax.swing.JInternalFrame {

    CTituloReceber controle;

    public VTituloReceber() {
        initComponents();

        controle = new CTituloReceber();
        ...
        titulosTable.setModel(new TituloReceberTableModel(null));
    }
    ...
    private void initComponents() {
        ...
        idfinanceira.setName("idfinanceira");
        idfinanceira.setNextFocusableComponent(observacao);
    ...
    private void titulosTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_titulosTableMouseClicked
        if (evt.getClickCount() > 1) {
            ...
            controle.setObjeto(this, (TituloReceber) ((TituloReceberTableModel) titulosTable.getModel()).getLinha(modelRow));
        }
    }//GEN-LAST:event_titulosTableMouseClicked

    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        CFrame.fechaVisao(CFrame.VISOES.TITULO_RECEBER);
    ...
    private void dataEmissaoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_dataEmissaoFocusLost
        ...
        controle.criticaDataEmissao(this);
