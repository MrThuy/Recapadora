 ...
 * @author Arthur
 */
public class CFichaCorrentista {
    ...
    public void fichaCadastro(int iddestinatario) {
        fichaCadastro(CCorrentista.procuraCorrentista(iddestinatario));
    }

    public void fichaCadastro(Correntista destinatario) {
        InputStream inputStream = getClass().getResourceAsStream("/erp/relatorios/FichaCadastro.jasper");
        ...
        try {
            ...
            ERPRelatorios.openReport("Ficha Cadastro", inputStream, parametros, ds);
